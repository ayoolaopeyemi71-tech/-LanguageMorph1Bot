...
BOT_USERNAME = os.environ.get('BOT_USERNAME', 'LanguageMorph1Bot')
BOT_NAME = os.environ.get('BOT_NAME', 'LanguageMorph1Bot')
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        f"I'm @{BOT_USERNAME}, your language morphing bot!\n\n"
        "🔄 *What I can do:*\n"
...
async def about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    about_text = (
        ...
        "Romanian, Swedish, Ukrainian, Hungarian,\n"
        "Czech, Danish\n\n"
